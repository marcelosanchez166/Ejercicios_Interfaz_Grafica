...
masculino=Radiobutton(raiz,text="Masculino", variable=varOpcion, value=1, command=imprimirOpcion).pack()
...
def opcionesDeportes():
          ...
          opciones=Message.config(text=opcionescogida)#Se le pasa al label la opcion escogida
