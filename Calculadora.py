...
#------------Fila 1 de Botones-------------------------
boton7=Button(miframe,text="7",width=4, pady=8, command=lambda:pulsarnum("7"))
boton7.grid(row=1,column=0)
boton8=Button(miframe,text="8",width=4, pady=8, command=lambda:pulsarnum("8"))
boton8.grid(row=1,column=1)
boton9=Button(miframe,text="9",width=4, pady=8, command=lambda:pulsarnum("9"))
...
#------------Fila 2 de Botones-------------------------
boton4=Button(miframe,text="4",width=4, pady=8, command=lambda:pulsarnum("4"))
boton4.grid(row=2,column=0)
boton5=Button(miframe,text="5",width=4, pady=8, command=lambda:pulsarnum("5"))
boton5.grid(row=2,column=1)
boton6=Button(miframe,text="6",width=4, pady=8, command=lambda:pulsarnum("6"))
boton6.grid(row=2,column=2)
botonMulti=Button(miframe,text="X",width=4, pady=8,command=lambda:multi(numpantalla.get()))
botonMulti.grid(row=2,column=3)


#------------Fila 3 de Botones-------------------------
boton1=Button(miframe,text="1",width=4, pady=8, command=lambda:pulsarnum("1"))
boton1.grid(row=3,column=0)
boton2=Button(miframe,text="2",width=4, pady=8, command=lambda:pulsarnum("2"))
boton2.grid(row=3,column=1)
boton3=Button(miframe,text="3",width=4, pady=8, command=lambda:pulsarnum("3"))
...
#------------Fila 4 de Botones-------------------------
boton0=Button(miframe,text="0",width=4, pady=8, command=lambda:pulsarnum("0"))
boton0.grid(row=4,column=0)
botonpunto=Button(miframe,text=".",width=4, pady=8, command=lambda:pulsarnum("."))
...
botonigual=Button(miframe, text="=",width=4, pady=8, command=lambda:el_resultado() )
...
def pulsarnum(numero):
          ...
          if resetear_pantalla!=False:
                    ...
                    numpantalla.set(numpantalla.get()+numero)#setea la variable y la pasa al cuadro numpantalla y concatena el numero
